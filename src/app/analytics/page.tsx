...
export default function AnalyticsPage() {
    ...
    const stats = [
        ...
        { label: 'Close Rate', tooltip: TOOLTIP_CONTENT.CLOSE_RATE, value: ((leads.filter((l: any) => l.status === 'Bought').length / (leads.length || 1)) * 100).toFixed(1) + '%', change: '0%', positive: true, icon: MessageSquare, color: 'text-indigo-500' },
    ];
    ...
    return (
        <div className="min-h-screen bg-slate-950 text-white font-sans selection:bg-indigo-500/30">
            ...
            <main className="max-w-7xl mx-auto px-6 lg:px-12 py-12">
                ...
                {/* Strategic Pulse History Table Section */}
                <div className="space-y-8 mb-24">
                    <div className="flex items-center justify-between px-4">
                        <div className="flex items-center gap-4">
