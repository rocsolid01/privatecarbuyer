              ...
              <div className="flex items-center gap-8">
                ...
                <div>
                  ...
                  <p className="text-slate-500 text-sm font-medium leading-relaxed max-w-md">
                    Your current strategy in <strong>Phoenix/Scottsdale</strong> yields 4x more High-Margin candidates than coastal zones. Consider re-allocating sniper resources.
                  </p>
                </div>
              </div>
