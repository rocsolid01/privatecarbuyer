        ...
        <div className="min-h-screen bg-slate-950 text-white font-sans selection:bg-indigo-500/30">
            ...
            <main className="max-w-7xl mx-auto px-6 lg:px-12 py-12">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
                    <div className="space-y-2">
                        <div className="flex items-center gap-3">
                            ...
                            <h1 className="text-4xl font-black italic uppercase tracking-tighter text-white">Strategic <span className="text-indigo-500">Intelligence</span></h1>
                        </div>
                        <p className="text-slate-500 font-black uppercase text-[10px] tracking-[0.3em] italic ml-5">Engine Performance Metrics & ROI</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
                    {stats.map((stat, i) => (
                        <div key={i} className="glass-card bg-slate-900/40 p-8 rounded-[2.5rem] border border-white/5 transition-all hover:border-indigo-500/30 group relative overflow-hidden">
